            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <?php if ($_SESSION['user'] ?? false) : ?><a href="/notes" class="<?= urlIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Notes</a>
                        <?php endif ?>
                        ...
                        <div class="flex justify-center">
                            <?php if ($_SESSION['user'] ?? false) : ?>
                                ...
                                <form method="POST" action="/session">
                                    ...
                                    <button class="bg-gray-900 text-red-500 hover:bg-gray-700 hover:text-white px-3 py-2 text-xs"> Log Out </button>
                                </form>
                            <?php else : ?>
